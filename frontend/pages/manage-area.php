...
<div class="manage-area-page">
    ...
    <div class="area-table-wrapper">
        <table class="area-table">
            ...
            <tbody id="area-table-body">
                <?php $count = $offset + 1; while ($area = mysqli_fetch_assoc($areas)) : ?>
                <tr>
                    <td><?= $count++ ?></td>
                    <td><?= htmlspecialchars($area['area_name']) ?></td>
                    <td><?= htmlspecialchars($area['description']) ?></td>
                    <td><?= htmlspecialchars($area['postcode']) ?></td>
                    <td>
    ...
    <div class="area-pagination">
        ...
        <div class="area-page-btns">
            ...
            <a href="dashboard.php?page=manage-area&area_page=<?= $area_page + 1 ?>" class="area-page-btn">Next &raquo;</a>
            <?php endif; ?>
        </div>
    </div>
    <?php endif; ?>
    ...
    <div class="area-modal-box">
        ...
        <div class="area-modal-body">
            ...
            <div class="area-modal-field">
                ...
                <input type="text" id="area-add-postcode" placeholder="e.g. AL10 9AB">
            </div>
        </div>
...
<div id="area-edit-modal" class="area-modal-overlay" style="display:none;">
    <div class="area-modal-box">
        ...
        <div class="area-modal-body">
            ...
            <div class="area-modal-field">
                <label>Postcode</label>
                <input type="text" id="area-edit-postcode" placeholder="e.g. AL10 9AB">
            </div>
        </div>
        <div class="area-modal-footer">
        ...
        fetch('../pages/manage-area.php', { method: 'POST', body: formData })
            ...
            .then(text => {
                try {
                    ...
                    showAreaMessage('Something went wrong. Please try again.', 'error');
                }
            })
